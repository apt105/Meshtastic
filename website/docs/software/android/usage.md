...
You will need a device with Meshtastic installed to go any further. See the [flashing firmware](getting_started/flashing_firmware) section for information on how to do this.
