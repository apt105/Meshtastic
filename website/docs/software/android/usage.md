...
You will need a device with Meshtastic installed to go any further. See the [flashing firmware](/docs/getting_started/flashing_firmware_getting_started) section for information on how to do this.
